...
# TUNING
MAX_RETRIES = 7  # used in exponetial backoff when checking a transaction
...
class Config:
    ...
    def __init__(self,
        ...
        try:
            ...
            raise UnsupportedEpochVersion(f"Unable to understand node reply, peraphs is not an epoch node or is too old?")
